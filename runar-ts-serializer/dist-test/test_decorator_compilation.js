...
let TestProfile = (() => {
    ...
    var TestProfile = class {
        ...
        static {
            ...
            __esDecorate(null, null, _systemField_decorators, { kind: "field", name: "systemField", static: false, private: false, access: { has: obj => "systemField" in obj, get: obj => obj.systemField, set: (obj, value) => { obj.systemField = value; } }, metadata: _metadata }, _systemField_initializers, _systemField_extraInitializers);
            __esDecorate(null, null, _userField_decorators, { kind: "field", name: "userField", static: false, private: false, access: { has: obj => "userField" in obj, get: obj => obj.userField, set: (obj, value) => { obj.userField = value; } }, metadata: _metadata }, _userField_initializers, _userField_extraInitializers);
        ...
        userField = (__runInitializers(this, _systemField_extraInitializers), __runInitializers(this, _userField_initializers, 'user_value'));
        constructor(name) {
