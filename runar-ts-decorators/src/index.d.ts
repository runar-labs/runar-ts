...
export declare function Plain(options?: PlainOptions): (value: Function, context: ClassDecoratorContext) => void;
export declare function EncryptField(options: EncryptFieldOptions): (initialValue: unknown, context: ClassFieldDecoratorContext<any, unknown>) => unknown;
export declare function Encrypt<T extends Constructor>(value: T, context: ClassDecoratorContext): void;
export declare function runar(label: string): <T, V>(initialValue: V, context: ClassFieldDecoratorContext<T, V>) => V;
...
export type EncryptedClass<T> = T extends new (...args: any[]) => infer R ? new (...args: any[]) => R & {
