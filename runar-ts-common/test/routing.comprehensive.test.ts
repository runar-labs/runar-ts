...
describe('Comprehensive TopicPath and PathTrie Tests (Mirroring Rust)', () => {
  ...
  describe('PathTrie Template and Wildcard Matching', () => {
    ...
    it('should match template patterns and extract parameters', () => {
      ...
      trie.setValue(
        TopicPath.new("services/{service_path}/state", "network1"),
        "TEMPLATE"
      );
    ...
    it('should handle network isolation', () => {
      ...
      trie.setValue(
        TopicPath.new("services/math/state", "network1"),
        "MATH_NETWORK1"
      );

      trie.setValue(
        TopicPath.new("services/math/state", "network2"),
        "MATH_NETWORK2"
      );
    ...
    it('should match wildcard patterns', () => {
      ...
      trie.setValue(
        TopicPath.new("services/*/state", "network1"),
        "WILDCARD"
      );
    ...
    it('should handle multi-segment wildcard patterns', () => {
      ...
      trie.setValue(
        TopicPath.new("services/>", "network1"),
        "MULTI_WILDCARD"
      );
    ...
    it('should handle wildcard search with intermediate nodes', () => {
      ...
      trie.setValue(
        TopicPath.new("users_db/execute_query", "network1"),
  ...
  describe('Advanced PathTrie Scenarios', () => {
    ...
    it('should handle all template positions', () => {
      ...
      trie.setValue(
        TopicPath.new("{type}/services/state", "network1"),
        "START_TEMPLATE"
      );

      // Template at end
      trie.setValue(
        TopicPath.new("services/state/{param}", "network1"),
        "END_TEMPLATE"
      );

      // Template in all positions
      trie.setValue(
        TopicPath.new("{a}/{b}/{c}", "network1"),
        "ALL_TEMPLATES"
      );
    ...
    it('should handle deep path matching with multi-wildcard', () => {
      trie.setValue(
        TopicPath.new("services/math/>", "network1"),
        "TEMPLATE_THEN_MULTI"
      );
